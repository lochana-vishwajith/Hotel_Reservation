    ...
    <div>
        ...
        <div class="row">
          <div class="col">
            <div class="card">
              <img
                class="card-img-top"
                src="https://res.cloudinary.com/iplus/image/upload/v1660382858/test/11856-the-majestic-yosemite-hotel-dining-room-1000_fwjahh.jpg"
                alt="Card image cap"
              />
              <div class="card-body">
          ...
          <div class="col">
            <div class="card">
              <img
                class="card-img-top"
                src="https://res.cloudinary.com/iplus/image/upload/v1660382857/test/photo-1611892440504-42a792e24d32_fn2nvd.jpg"
                alt="Card image cap"
              />
              <div class="card-body">
                <h5 class="card-title">Accommodation</h5>
                <p class="card-text">
                  The resort is made up of several beautifully crafted chalets
                  tucked within the leveled landscape of the plantation.
                </p>
                <Link to="/accommadation" class="btn btn-primary">
                  Go somewhere
                </Link>
              </div>
            </div>{" "}
          ...
          <div class="col">
            <div class="card">
              <img
                class="card-img-top"
                src="https://res.cloudinary.com/iplus/image/upload/v1660383042/test/ssss_tf7xlp.jpg"
                alt="Card image cap"
              />
              <div class="card-body">
                <h5 class="card-title">Things To Do</h5>
                <p class="card-text">
                  Olive Garden is probably one of Sri Lanka’s best kept secrets
                  that offers plenty to keep you fascinated.
                </p>
                <a href="#" class="btn btn-primary">
                  Go somewhere
                </a>
      ...
      <div
        ...
        style={{
          color: "#fff",
          background:
            "url(https://res.cloudinary.com/iplus/image/upload/v1660386387/test/banner1_copy_lkhqr3.png) bottom right 12% no-repeat #46B6AC",
        }}
      >
        <div
          style={{
        ...
        >
          <div class="row">
            <div class="col">
              <div class="card" style={{ width: "28rem" }}>
                <a href="https://www.google.com/maps/place/Nanuoya/@6.9408098,80.7332468,15z/data=!4m13!1m7!3m6!1s0x3ae3816b190f1fbf:0xfe235f7181c8688d!2sNanuoya!3b1!8m2!3d6.9403158!4d80.7408429!3m4!1s0x3ae3816b3434868d:0xa5086abd51b6a738!8m2!3d6.94235!4d80.74372">
                  <img
                    class="card-img-top"
                    src="https://res.cloudinary.com/iplus/image/upload/v1660384974/test/Untitled_yg39jq.png"
                    alt="Card image cap"
                  />
                </a>
              </div>
            ...
            <div class="col">
              <div>
                <p style={{ color: "white" }}>
                  Location: Located in Nanuoya, near Nuwaraeliya, within the Uva
                  province of Sri Lanka, 198 Acres Resort and Spa stands
                  surrounded with a tea estate.Easy access to Nanuoya train
                  staion, Nuwaraeliya town.
                </p>
              </div>
            </div>
          </div>
